...
export interface QuizTopic extends BaseEntity {
...
export interface QuizTopicRequest {
     quizGroup: number;
     title: string;
     description: string;
     slug: string;
...
export interface QuizTopicResponse extends QuizTopic {
     groupName: string;
     totalMockTest: number;
}

export interface QuizTopicView extends QuizTopic {
    totalMockTest: number;
}