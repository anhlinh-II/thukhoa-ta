...
import type { Prisma, Permission } from "./__types";
...
export function useInfiniteFindManyPermission<TArgs extends Prisma.PermissionFindManyArgs, TQueryFnData = Array<Prisma.PermissionGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: Prisma.SelectSubset<TArgs, Prisma.PermissionFindManyArgs>, options?: Omit<UseInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>>, 'queryKey' | 'initialPageParam'>) {
...
export function useSuspenseInfiniteFindManyPermission<TArgs extends Prisma.PermissionFindManyArgs, TQueryFnData = Array<Prisma.PermissionGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: Prisma.SelectSubset<TArgs, Prisma.PermissionFindManyArgs>, options?: Omit<UseSuspenseInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>>, 'queryKey' | 'initialPageParam'>) {
    options = options ?? { getNextPageParam: () => null };
    const { endpoint, fetch } = getHooksContext();
